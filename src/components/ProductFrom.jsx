            ...
            <div className="container">
                <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
                    ...
                    <div className="mx-auto max-w-2xl text-center">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Fill the Forms</h2>
                        <p className="mt-2 text-lg leading-8 text-gray-600">Give your Feedback to improve the services</p>
                    </div>
                    <form className="mx-auto mt-16 max-w-xl sm:mt-20" action={handleSubmit} >
                        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="relative mt-2.5">
                                    ...
                                    <input type="text" name="phone-number" id="phone-number" autoComplete="tel" className="block w-full rounded-md border-0 px-3 py-2  text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
                            <div className="sm:col-span-2">
                        ...
                        <div className="mt-10 flex justify-center items-center">
                            <button type="button" className="block w-40 mx-3 rounded-md bg-red-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Back to Users</button>

                            <button type="submit"  className="block w-40 mx-3 rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
                        </div>
                    </form>
